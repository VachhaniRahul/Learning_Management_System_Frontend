...
function Index() {
    ...
    const fetchLmsData = async() => {
        setIsLoading(true)
        try {
            const res = await api.get('lms/details/')
            setData(res.data)
            setIsLoading(false)
        } catch (error) {
                        ...
                        <div className="row mb-5">
                            <div className="col-md-6 col-lg-3 border-top-md border-top pb-4  border-end-md">
                                ...
                                <div className="py-7 text-center">
                                    ...
                                    <div className="lh-1">
                                        <h2 className="mb-1">{data?.teacher_count || 0}</h2>
                            ...
                            <div className="col-md-6 col-lg-3 border-top-md border-top border-end-lg">
                                ...
                                <div className="py-7 text-center">
                                    ...
                                    {/* text */}
                                    <div className="lh-1">
                                        <h2 className="mb-1">{data?.enrolled_count || 0}</h2>
                            ...
                            <div className="col-md-6 col-lg-3 border-top-lg border-top border-end-md">
                                ...
                                <div className="py-7 text-center">
                                    ...
                                    {/* text */}
                                    <div className="lh-1">
                                        <h2 className="mb-1">{data?.course_count|| 0}</h2>
                            ...
                            <div className="col-md-6 col-lg-3 border-top-lg border-top">
                                ...
                                <div className="py-7 text-center">
                                    ...
                                    {/* text */}
                                    <div className="lh-1">
                                        <h2 className="mb-1">{data?.lecture_count || 0}</h2>
                    ...
                    <div className="row align-items-center bg-primary gx-0 rounded-3 mt-5">
                        ...
                        <div className="col-lg-6 col-12 d-none d-lg-block">
                            <div className="d-flex justify-content-center pt-4">
                                <div className="position-relative">
                                    <img
                                        src="https://codescandy.com/geeks-bootstrap-5/assets/images/instructor/instructor-img.png"
                                        alt="Instructor"
                                    ...
                                    <div className="ms-n8 position-absolute bottom-0 start-0 mb-6">
                                        <img
                                            src="https://codescandy.com/geeks-bootstrap-5/assets/images/svg/dollor.svg"
                                            alt="dollar"
                                        />
                                    </div>
                                    <div className="me-n4 position-absolute top-0 end-0">
                                        <img
                                            src="https://codescandy.com/geeks-bootstrap-5/assets/images/svg/graph.svg"
                                            alt="graph"
                                        />
                                    </div>
                                </div>
                        ...
                        <div className="col-lg-5 col-12">
                            <div className="text-white p-5 p-lg-0">
                                ...
                                <p className="mb-0">
                                    Instructors from around the world teach millions of students on our platform.
